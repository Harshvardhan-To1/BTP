...
\hypersetup{
  pdftitle={Fronthaul Load Management for B5G Wireless Communications},
  pdfauthor={Harshvardhan Choudhary, Mayank Yadav}
}
...
{\large Indian Institute of Technology Indore}\\[1.05em]
{\LARGE\bfseries Fronthaul Load Management\\[0.15em]
for B5G Wireless Communications}\\[0.85em]
{\Large\bfseries B.Tech.\ Project}\\[0.15em]
{\Large Mid-Semester Evaluation Report}\\[0.35em]
Academic Year 2026--27\\[0.7em]
Project No.: P22\\
Specialization: CSP\\[0.75em]
{\large Submitted by}\\[0.45em]
\textbf{Harshvardhan Choudhary}\\
Roll No.: 230002027\\[0.45em]
\textbf{Mayank Yadav}\\
Roll No.: 230002041\\[0.7em]
{\large Under the guidance of}\\[0.4em]
\textbf{Dr.\ Sumit Gautam}\\[0.75em]
September 2026
\end{center}
